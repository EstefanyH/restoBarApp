...
class AuthenticationAPI {
  ...
  Future<GenericResponse> login(String email, String psw) async {
    String urlfinal = sprintf(ApiService.login, [email, psw]);
    final result = await _http.request(sprintf(ApiService.login, [email, psw]),
    ...
    if (result.error == null){
      ...
      return _functions.responseFromJson(HttpResponse.ok, result.data['message'], result.data['data']);
    } 
